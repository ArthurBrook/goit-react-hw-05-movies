...
import MoviesSearchList from 'components/MoviesSearchList/MoviesSearchList';  // Змінено шлях
...
const Movies = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://api.themoviedb.org/3/search/movie?api_key=6301db5528ae45d4f093ae068f5e98be&query=${title}&include_adult=false&language=en-US&page=1`,
      options
    )
